...
import { doc, getDoc, collection, addDoc, deleteDoc, query, where, getDocs, serverTimestamp, onSnapshot } from 'firebase/firestore';
...
function RideDetails() {
  ...
  useEffect(() => {
    ...
    const docRef = doc(db, 'listings', rideId);
  ...
  if (!ride) {
    return (
      <div className="container mx-auto px-4 py-8 text-center">
        ...
        <p className="text-muted-foreground">The ride you are looking for does not exist or has been removed.</p>
            ...
            <div className="space-y-6">
                ...
                <Card>
                    ...
                    <CardContent className="space-y-4">
                        <p className="font-semibold">{ride.owner.name}</p>
